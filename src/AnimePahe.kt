package eu.kanade.tachiyomi.extension.en.animepahe
...
class AnimePahe : HttpSource() {
    override val name = "AnimePahe"
    override val baseUrl = "https://www.animepahe.org"
    override val lang = "en"
    override val supportsLatest = true

    override fun popularAnimeRequest(page: Int): Request {
        return GET("$baseUrl/api?m=airing&page=$page", headers)
    }

    override fun popularAnimeParse(response: Response): AnimesPage {
        val json = response.body.string()
        val data = json.substringAfter("\"data\":").substringBefore(",\"meta\"")
        val animes = Jsoup.parse(data).select("div.anime").map {
            SAnime.create().apply {
    ...
    override fun searchAnimeRequest(page: Int, query: String, filters: FilterList): Request {
        return GET("$baseUrl/api?m=search&q=$query&page=$page", headers)
    }
    ...
    override fun latestUpdatesRequest(page: Int): Request {
        return GET("$baseUrl/api?m=recent&page=$page", headers)
    }
